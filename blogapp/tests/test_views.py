...
class registerViewTest(TestCase):
    ...
    def test_RegisterUseCorrectTemplate(self):
        response = self.client.get(reverse('signup'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "blogapp/register.html")
...
class  userLoginViewTest(TestCase):
    ...
    def test_UserLoginUseCorrctTemplate(self):
        response = self.client.get(reverse('login'))
        self.assertTrue(response.status_code, 200)
        self.assertTemplateUsed(response, 'blogapp/signin.html')
...
class userLogOutViewTest(TestCase):
    ...
    def test_LogoutUseCorrectTemplate(self):
        response = self.client.get(reverse('logout'))
        self.assertTrue(response.status_code, 200)
        self.assertTemplateUsed(response, 'blogapp/signout.html')
