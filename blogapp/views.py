...
def register(request):
    ...
    return render(request, 'blogapp/register.html', {'user_form': user_form, 'profile_form':profile_form, 'registered':registered})
...
def user_profile(request):
    ...
    return render(request, "blogapp/profile.html", {"user": user, "user_profile": user_profile, "img_url": image_url, "user_form": user_form, "profile_form": user_profile_form})
...
def main_user_home(request):
    ...
    return render(request, "blogapp/home_page.html", {"user_profile": user_profile, "img_url":img_url, "post_form": post_form, "posts":post, "follower_count":follower_count, "following_count": following_count})
...
def user_search(request):
    if request.method == "POST":
        ...
        if search:
            ...
            return render(request, "blogapp/user_search.html", {'search_result': search_result})
        else:
            return render(request, 'blogapp/user_search.html')
    else:
        return HttpResponseRedirect("/")
...
def network_list(request):
    if request.method == "GET":
        ...
        return render(request, "blogapp/connection_list.html", {"follower_list": follower_list, "following_list": following_list})
    else:
